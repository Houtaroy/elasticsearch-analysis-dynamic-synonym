 ...
 * output.  This is a replacement for {@link org.apache.lucene.analysis.synonym.SynonymFilter}, which produces
 ...
 * like {@link org.apache.lucene.analysis.synonym.SynonymFilter}, because the indexer can't directly
...
public final class DynamicSynonymGraphFilter extends IDynamicSynonymFilter {
  ...
  private final RollingBuffer<BufferedInputToken> lookahead = new RollingBuffer<BufferedInputToken>() {
    @Override
